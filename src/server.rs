    ...
    <main class="with-sidebar">
      ...
      <section class="toolbar panel panel-strong">
        ...
        <div class="toolbar-row" id="filter-builder-row">
          <input id="viewer-query-input" data-testid="viewer-query-input" type="text" placeholder="Simple text search (optional)" aria-label="Text search query" style="flex:1;min-width:180px;" />
